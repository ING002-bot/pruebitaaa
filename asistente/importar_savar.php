...
<body>
                                    ...
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            ...
                                            <div class="bg-dark text-light p-3 rounded">
                                                <code>cd c:\xampp\htdocs\pruebitaaa\python</code><br>
                                ...
                                <div class="col-md-6">
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="importar_savar_procesar.php" onsubmit="return confirm('¿Iniciar importación desde SAVAR?\n\nEsto puede tardar varios minutos.');">
                                                <div class="mb-3">
    ...
    <script>
        function verDetalles(id) {
            // Aquí puedes abrir un modal con los detalles de la importación
            alert('Función para ver detalles de la importación #' + id + ' - Por implementar');
        }

        function verErrores(id) {
            // Redirigir a página de errores
            window.open('../admin/importar_errores.php?id=' + id, '_blank');
        }

        // Auto-refresh cada 30 segundos si hay importaciones en proceso
        setTimeout(() => {
            const procesandoBadges = document.querySelectorAll('.badge.bg-info');
            if (procesandoBadges.length > 0) {
                location.reload();
            }
        }, 30000);
