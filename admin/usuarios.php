                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="apellido" class="form-control" required pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" title="Solo se permiten letras y espacios">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="telefono" class="form-control" pattern="[\+]?[0-9\s\-\(\)]+" title="Solo números, espacios, guiones y paréntesis">
                        </div>
                        <div class="mb-3">
